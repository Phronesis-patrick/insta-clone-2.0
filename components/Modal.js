...
const addImageToPost = (e) =>{
    ...
    return (
         <Transition.Root show={clue} as={Fragment}>
        <Dialog 
        as="div" 
        ...
        text-center sm:block sm:p-0">
           ...
           <Transition.Child
            ...
            rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8
    ...
    <div className="mt-3 text-center sm:mt-5">
     ...
     placeholder="please enter a caption..."/>
                ...
                <button type="button" disabled={!selectedFile} className="inline-flex justify-center w-full rounded-md
                ...
                focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled-gray-100
